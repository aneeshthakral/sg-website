...
// Background: var(--color-section-break) | Gradient: none | Grain: no
...
export default function HowWeWork({ asPageTitle = false }: { asPageTitle?: boolean }) {
  ...
  return (
    <section
      id="how-we-work"
      aria-label="How we work — four-step process from discovery to scale"
      ref={sectionRef}
      style={{
        backgroundColor: 'var(--color-section-break)',
    ...
    >
      ...
      >
        <ScrollReveal>
          <SectionLabel color="var(--color-caption-light)">The Process</SectionLabel>
          {asPageTitle ? (
            <h1
              style={{
                fontFamily: 'var(--font-family-display)',
