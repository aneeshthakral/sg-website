...
// Background: dark (var(--color-deep)) | Gradient: cool-atmosphere from right
...
export default function WhatWeBuild() {
  ...
  return (
    ...
    >
      ...
      >
        <ScrollReveal>
          <SectionLabel color="var(--color-blaze)">Services</SectionLabel>
          <h2
            style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          {services.map((service, i) => {
            const isRight = i % 2 !== 0
            const accentColor = 'var(--color-blaze)'
            ...
            return (
              ...
              >
                <div
                  style={{
                    borderBottom: i < services.length - 1 ? '1px solid var(--color-elevated)' : 'none',
                  }}
                >
                  <div
                    style={{
