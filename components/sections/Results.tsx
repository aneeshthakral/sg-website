// Section 5 — Results
// Background: dark (var(--color-deep)) | Gradient: infrared-wash
...
export default function Results({ asPageTitle = false }: { asPageTitle?: boolean }) {
  return (
    <section
      id="results"
      aria-label="Results — enterprise revenue and engagement metrics"
      style={{
    ...
    >
      ...
      >
        <ScrollReveal>
          <SectionLabel color="var(--color-blaze)">Results</SectionLabel>
          {asPageTitle ? (
            <h1
              style={{
