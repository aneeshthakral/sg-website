          ...
          {submitted ? (
            ...
            >
              <div
                style={{
                  ...
                  height: '56px',
                  borderRadius: '50%',
                  border: '2px solid var(--color-blaze)',
                  display: 'flex',
                  alignItems: 'center',
            ...
            >
              ...
              >
                {/* Left — Form */}
                <div>
                  <SectionLabel color="var(--color-blaze)">Send a Message</SectionLabel>
                  <h2
                    style={{
                      fontFamily: 'var(--font-family-display)',
                      fontSize: 'var(--text-section)',
                  ...
                  <form onSubmit={handleSubmit} noValidate>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                      ...
                      {/* Service Interest */}
                      <div>
                        <label htmlFor="service" className="sg-label">
                          Service Interest
                        </label>
                        <select
                          id="service"
                        ...
                        >
                          ...
                          {SERVICE_OPTIONS.filter(Boolean).map((opt) => (
                    ...
                    <div>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        <a
                          ...
                          aria-label="StoryGrid & Co. on LinkedIn"
                          data-interactive
                          style={{
                            fontFamily: 'var(--font-family-body)',
                            fontSize: '15px',
                        ...
                        >
                          linkedin.com/company/storygrid-co
                        </a>
                        <a
                          href="https://instagram.com/storygrid.co"
                          target="_blank"
                          rel="noopener noreferrer"
                          aria-label="StoryGrid & Co. on Instagram"
                          data-interactive
                          style={{
                            fontFamily: 'var(--font-family-body)',
                            fontSize: '15px',
