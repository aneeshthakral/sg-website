...
const variantHover: Record<ButtonVariant, React.CSSProperties> = {
  primary: { background: 'var(--color-blaze)', color: 'var(--color-deep)' },
  ghost: { background: 'var(--color-elevated)', color: 'var(--color-heading)' },
  ai: { background: 'var(--color-blaze)', color: 'var(--color-deep)' },
  solid: { background: 'var(--color-blaze-glow)', color: 'var(--color-deep)' },
}
